        ...
        <div class="register-card animate__animated animate__fadeInUp">
            ...
            <form id="studentRegisterForm" method="post" action="?controller=student&action=register" enctype="multipart/form-data" autocomplete="off" novalidate>
                ...
                <div class="mb-3 position-relative">
                    <label for="cv" class="form-label text-white-50">
            ...
            <div class="text-center mt-4">
                <a href="?controller=student&action=login" class="text-white-50 text-decoration-none">
                    <i class="bi bi-arrow-left me-1"></i>Already have an account? <b class="gradient-text-yellow">Login</b>
                </a>
            </div>
        </div>
    </div>
