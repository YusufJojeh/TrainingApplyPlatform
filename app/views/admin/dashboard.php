                                ...
                                ?>
                                    <tr style="background: rgba(0,0,0,0.55); border-radius: 1rem; color: #fff; transition: background 0.2s;">
                                        ...
                                        <td class="align-middle">
                                            ...
                                            ?>
                                            <span class="badge bg-<?= $statusClass ?> text-white fw-bold" style="font-size:1rem;"> <?= $statusText ?> </span>
                                        </td>
                                        <td class="text-white-50 align-middle">
                                        ...
                                        <td class="align-middle">
                                            <a href="?controller=application&action=detail&id=<?= $app['id'] ?>" 
                                               class="btn btn-sm btn-outline-warning text-white" style="border-color: #ffe259; color: #ffe259;">
